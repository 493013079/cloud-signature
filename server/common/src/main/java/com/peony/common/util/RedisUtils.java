...
public class RedisUtils {
	 ...
	 * @return
	 */
	public <T> T lLeftPop(String key, long timeOut, TimeUnit timeUnit, Class<T> clazz){
		try {
	 ...
	 * @return
	 */
	public <T> T lRightPop(String key, long timeOut, TimeUnit timeUnit, Class<T> clazz){
		try {
